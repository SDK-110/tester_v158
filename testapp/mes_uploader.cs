...
namespace testapp_mes
{
    public class mes_uploder
    {
        ...
        public mes_uploder()
        {
            ...
            foreach (var m in p) {
                _params_.Add(m.KeyName, m.Value);
            }
        }
        ...
        public (string,string)  _mes_uploder (string _lbId= "sn_123456789",string _partNum = "xxxxxxxxxxxx")
        {
            ...
            Request_data updata = new Request_data
            {
                ...
                curLbs = new _curLbs() { lbId = _lbId, partNum = _partNum },
                _params = _params_ ?? new Dictionary<string, string>() { { "xxxxx", "xxxxx" } }
        ...
        class Request_data
        {
            ...
            public _curLbs curLbs { set; get; }
            public Dictionary<string, string> _params { set; get; }
