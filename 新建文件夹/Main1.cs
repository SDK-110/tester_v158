...
namespace testapp
{
    ...
    public partial class Main1 : Form
    {
      ...
      volatile  int auto_status3 = 0;
        ...
        protected override void DefWndProc(ref Message ms)
        {
            ...
            switch (ms.Msg) {
                ...
                case WM_SENDA_3:
                    {
                        ...
                        string tmp = "";
                        if (iniread.ReadFile("setup.ini")["setport"]["Relay_board3"] != null)
                        {
                ...
                case WM_SENDA_4:
                    {
                        string tmp = "";
                        if (iniread.ReadFile("setup.ini")["setport"]["Relay_board4"] != null)
                        {
                ...
                case WM_BLE_PATH_LOSS_CH0:
                    {
                        dt["cmw100ParameterSet"]["buletoothpathloss_ch0"] = Marshal.PtrToStringAnsi(ms.LParam);
                        iniread.WriteFile("setup.ini", dt);
                    }
                    break;
                case WM_BLE_PATH_LOSS_CH20:
                    {
                        dt["cmw100ParameterSet"]["buletoothpathloss_ch20"] = Marshal.PtrToStringAnsi(ms.LParam);
                        iniread.WriteFile("setup.ini", dt);
                    }
                    break;
                case WM_BLE_PATH_LOSS_CH39:
                    {
                        ...
                        dt["cmw100ParameterSet"]["buletoothpathloss_ch39"] = Marshal.PtrToStringAnsi(ms.LParam);
                        iniread.WriteFile("setup.ini", dt);
                    }
                    break;
                ...
                case WM_SENDMYREALY_2:
                    {
                        if (iniread.ReadFile("setup.ini")["setport"]["myrelay_board2"] != null)
                        {
                            string temp;
                ...
                case WM_SK_RELAY1_SET:
                    {
                        if (iniread.ReadFile("setup.ini")["setport"]["sk_Relay_board"] != null)
                        {
                            string temp;
                ...
                case WM_SK_RELAY2_SET:
                    {
                        if (iniread.ReadFile("setup.ini")["setport"]["sk_Relay_board2"] != null)
                        {
                            string temp;
        ...
        {
            if (dt["statu"]["plc_auto"] != null) return;
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            var case_jumper = dt["statu"]["case_jumper"];
            ...
            try
            {
                ...
                while (1 == 1)
                {
                    ...
                    for (int rc = 0; rc < viewloader.tester_proj.test_cases.Count; rc++) {
                        ...
                        //等于yes继续跑
                        if (iniread.ReadFile("setup.ini")["statu"]["NG_RUN"] != "yes") {
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (e.Result == "fail" && dt["setproduct"]["lock"] != null) {
                this.Invoke(new Action(() => {
            ...
            string project_flog = dt["setproduct"]["logger"];
#if testlogs_teshu
            new System.Threading.Thread(() =>
            {
                ...
                if (is_teshu_logger_detection == true) {
                    ...
                    switch (project_flog) {
                        ...
                        case "desay_logger":
                            ...
                            if (dt["setproduct"]["line_number"] != null && dt["setproduct"]["personal_number"] !=null) { 
                            line_number = dt["setproduct"]["line_number"];
                            personal_number = dt["setproduct"]["personal_number"];
                            ...
                            if (resultt == "pass" )
                            {
                                ...
                                string filename = dt["setproduct"]["project"] + "_" + sn_temp.Trim() + "_" + DateTime.Now.ToString("yyMMddhhmmss") + "_Passed.csv";
                                utility_func.testlog_save_for_smx(ref testlogs,
                                                                "../smx/pass",
                                                                filename,
                                                                personal_number,
                                                               line_number,
                                                                dt["setproduct"]["project"],
                                                               sn_temp.Trim(),                                
                                                               textBox3.Text,
                                                               textBox4.Text,
                                                                "Passed"
                            ...
                            else
                            {
                                ...
                                string filename = dt["setproduct"]["project"] + "_" + sn_temp.Trim() + "_" + DateTime.Now.ToString("yyMMddhhmmss") + "_Failed.csv";
                                utility_func.testlog_save_for_smx(ref testlogs,
                                                                "../smx/fail",
                                                                filename,
                                                                personal_number,
                        ...
                        case "wiring_harness_log":
                                        ...
                                        if (resultt == "pass")
                                        {
                                            ...
                                            if (iniread.ReadFile("setup.ini")["wiring_harness"] != null)
                                            {
                                                ...
                                                string product_name = iniread.ReadFile("setup.ini")["wiring_harness"]["cable_test_order_part_number"];
                        ...
                        case "sgw_logger":
                                ...
                                if (resultt == "pass")
                                {
                                    ...
                                    string filename = dt["setproduct"]["project"] + "_" + sgw_record_mac + "_" + DateTime.Now.ToString("yyMMddhhmmss") + "_Passed.csv";
                                ...
                                else
                                {
                                    ...
                                    string filename = dt["setproduct"]["project"] + "_" + sgw_record_mac + "_" + DateTime.Now.ToString("yyMMddhhmmss") + "_Failed.csv";
                                    utility_func.testlog_save_for_sgw(ref testlogs,
                                                                    "./sgw/fail",
                                                                    filename,
                                                                   "'" + "S000331",
                        ...
                        case "asm_logger":
                                ...
                                if (resultt == "pass")
                                {
                                    ...
                                    string filename = dt["setproduct"]["project"] + "_" + sgw_record_sn.Replace(@"\","-").Replace(@"/","-") + "_" + DateTime.Now.ToString("yyMMddhhmmss") + "_Passed.csv";
                                ...
                                else
                                {
                                    ...
                                    string filename = dt["setproduct"]["project"] + "_" + sgw_record_sn + "_" + DateTime.Now.ToString("yyMMddhhmmss") + "_Failed.csv";
                                    utility_func.testlog_save_for_asm(ref testlogs,
                                                                    "./asm_lg/fail",
                                                                    filename,
                                                                   "'" + "S000331",
                        ...
                        case "pontial_coil_logger":
                                ...
                                if (resultt == "pass")
                                {
                                    ...
                                    string filename = dt["setproduct"]["project"] + "_" + sgw_record_sn + "_" + DateTime.Now.ToString("yyMMddhhmmss") + "_Passed.csv";
                                    utility_func.testlog_save_for_asm(ref testlogs,
   ...
   this.调试DEBUGToolStripMenuItem.Text = "调试debug";
    ...
    iniread.WriteFile("setup.ini", dt);
        ...
        private void 调试DEBUGToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //form3.Show();
            relay_debug_4 form4 = new relay_debug_4();
            form4.Show();
        ...
        private void Form1_Shown(object sender, EventArgs e)
        {
           ...
           //  timer2.Enabled = true;
            ...
            if (dt["setproduct"]["line_number"] != null && dt["setproduct"]["personal_number"] != null)
            {
                this.toolStripTextBox1.Text = dt["setproduct"]["personal_number"];
                


            }

            if (iniread.ReadFile("setup.ini")["setproduct"]["hbi_region"] != null)
            {
                this.toolStripStatusLabel2.ForeColor = Color.Blue;
                this.toolStripStatusLabel2.Text = "HBI Regin: [" + iniread.ReadFile("setup.ini")["setproduct"]["hbi_region"] + "]";
            }
#if wiring_harness
            if (iniread.ReadFile("setup.ini")["wiring_harness"] != null) {


                if (iniread.ReadFile("setup.ini")["wiring_harness"]["cable_test_production_line"] != null) {

                    this.toolStripStatusLabel3.ForeColor = Color.Blue;
                    this.toolStripStatusLabel3.Text = $"LineNo: [{iniread.ReadFile("setup.ini")["wiring_harness"]["cable_test_production_line"]}]";

                }

                if (iniread.ReadFile("setup.ini")["wiring_harness"]["cable_test_vendor_code"] != null)
                {

                    this.toolStripStatusLabel4.ForeColor = Color.Blue;
                    this.toolStripStatusLabel4.Text = $"VendorNo: [{iniread.ReadFile("setup.ini")["wiring_harness"]["cable_test_vendor_code"]}]";

                }


                if (iniread.ReadFile("setup.ini")["wiring_harness"]["cable_test_order_part_number"] != null)
                {

                    this.toolStripStatusLabel5.ForeColor = Color.Blue;
                    this.toolStripStatusLabel5.Text = $"PN: [{iniread.ReadFile("setup.ini")["wiring_harness"]["cable_test_order_part_number"]}]";

                }

                

           if (iniread.ReadFile("setup.ini")["wiring_harness"]["cable_test_meritor_Drawing_Revision"] != null)
                {

                    this.toolStripStatusLabel2.ForeColor = Color.Blue;
                    this.toolStripStatusLabel2.Text = $"DarwingRev: [{iniread.ReadFile("setup.ini")["wiring_harness"]["cable_test_meritor_Drawing_Revision"].PadLeft(5, '-')}]";
            ...
            if (iniread.ReadFile("setup.ini")["setproduct"]["ifautotest"] != null) {
        ...
        private void toolStripTextBox1_TextChanged(object sender, EventArgs e)
        {
                ...
                if (dt["setproduct"]["line_number"] != null && dt["setproduct"]["personal_number"] != null)
            {
                 dt["setproduct"]["personal_number"]= this.toolStripTextBox1.Text;
                iniread.WriteFile("setup.ini", dt);
