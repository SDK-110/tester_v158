   ...
   public class RS232PortOperator:PortOperatorBase,IPortType
    {
       ...
       private  FlowControl FlowControl { set; get; } = FlowControl.None;
  ...
  public  abstract class PortOperatorBase:IPortOperator
    {
       ...
       public virtual void OnPortOpenning(PortEventArgs e)
        {
            PortOpenning?.Invoke(this, e);
        }

        public virtual void OnPortClosing(PortEventArgs e)
        {
