...
using MyVISAInstrument.Configuration;
using MyVISAInstrument.Ports;
//using MyVISAInstrument.Properties;
using MyVISAInstrument.Mymodule;
using MyVISAInstrument.Mymodule.Extension;
using MyVISAInstrument.Mymodule.Extension.UI;
using Resources = testapp.MyVisa.Visa_Utility.my_visa_test;
namespace testapp.MyVisa
{
    public partial class FrmMain : Form
    {
        ...
        private MyVISAInstrument.Ports.PortOperatorBase _portOperatorBase;
        ...
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            ...
            _task = Task.Factory.StartNew(() =>
            {
                ...
                string[] content1 = PortHelper.FindAddresses(MyVISAInstrument.Mymodule.PortType.Rs232);
        ...
        private void rdoUntilNewLine_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void rbtRS232_CheckedChanged(object sender, EventArgs e)
        {
