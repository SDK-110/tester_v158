 ...
 public    class DM3058
    {
       ...
       try
        ...
        public string dm3058_dc_read_1000V()
        {
            DM3058OPerator.Write(":RATE:VOLTage:DC M");
            DM3058OPerator.Write(":MEASure:VOLTage:DC 4");
            System.Threading.Thread.Sleep(100);
            DM3058OPerator.Write(":MEASure:VOLTage:DC?");
            return DM3058OPerator.Read();
        }
        ...
        public string dm3058_ac_read__SLOW_750v()
        {
            DM3058OPerator.Write(":RATE:VOLTage:AC S");
            DM3058OPerator.Write(":MEASure:VOLTage:AC 4");
            System.Threading.Thread.Sleep(100);
            DM3058OPerator.Write(":MEASure:VOLTage:AC?");
            return DM3058OPerator.Read();
        ...
        public string dm3058_ac_read_20mA()
        {
            DM3058OPerator.Write(":RATE:CURRent:AC M");
            DM3058OPerator.Write(":MEASure:CURRent:DC 0");
            System.Threading.Thread.Sleep(100);
            DM3058OPerator.Write(":MEASure:CURRent:AC?");
            return DM3058OPerator.Read();
        }

        public string dm3058_ac_read_200mA()
        {
            DM3058OPerator.Write(":RATE:CURRent:AC M");
            DM3058OPerator.Write(":MEASure:CURRent:DC 1");
            System.Threading.Thread.Sleep(100);
        ...
        public string dm3058_ac_read_2A()
        {
            DM3058OPerator.Write(":RATE:CURRent:AC M");
            DM3058OPerator.Write(":MEASure:CURRent:DC 2");
            System.Threading.Thread.Sleep(100);
        ...
        public string dm3058_ac_read_10A()
        {
            DM3058OPerator.Write(":RATE:CURRent:AC M");
            DM3058OPerator.Write(":MEASure:CURRent:DC 3");
            System.Threading.Thread.Sleep(100);
        ...
        public string dm3058_read_DIODs()
        {
            DM3058OPerator.Write(":MEAS:DIOD?");
            return DM3058OPerator.Read();
        }
