RsInstrument is a .NET component that provides convenient way of communicating with R&S instruments over VISA
It uses VISA-C implementation (tested with R&S VISA and NI VISA) to build instrument model layer 
that provides all the required tasks you might need when remote-controlling your instrument:
