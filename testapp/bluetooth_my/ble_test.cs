...
namespace test_blue_dll
{
    public class test_blue
    {
        ...
        public test_blue(string device_name_or_mac, int ismac = 1, sendmessage st =null)
        {
            ...
            new System.Threading.Thread(() =>
            {
                try
                {
                    ...
                    if (bleCore != null) bleCore.Dispose();
       ...
       ~test_blue()
        ...
        public  string  get_rx_date(string uuid = "00002a00-0000-1000-8000-00805f9b34fb")
        {
      

                for(int i=0; !(bleCore.is_get_ser);i++) { System.Threading.Thread.Sleep(100); if (i > 30) return "null"; }
