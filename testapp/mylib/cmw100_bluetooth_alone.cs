...
{
    class cmw100_bluetooth_tx_alone
    {
        static RsCmwBluetoothMeas driver = null;
        public cmw100_bluetooth_tx_alone(String resource = "TCPIP0::127.0.0.1::inst0::INSTR",int rxconnector=120/* rf1c*/ , int rxconverter = 20 /*rx1*/)
        {
           
            driver = new RsCmwBluetoothMeas(resource,false,true);
            driver.Route.Scenario.Salone.RxConnector = RohdeSchwarz.RsCmwBluetoothMeas.RxConnectorEnum.RF1C;
            driver.Route.Scenario.Salone.RfConverter = RohdeSchwarz.RsCmwBluetoothMeas.RxConverterEnum.RX1;
        ...
        public int getTxfreq_offsetResult(out double[] m,double centerfreq = 2442000000, double Eattenuation = 0 , double EnvelopePower=0, double threshold_value = -40) {
    ...
    //}
    class cmw100_bluetooth_rx_alone
    {
        static RsCmwGprfGen driver= null;
        public cmw100_bluetooth_rx_alone(String resource = "TCPIP0::127.0.0.1::inst0::INSTR")
        {
