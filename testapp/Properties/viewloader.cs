...
namespace 重构程序.viewmode
{
    ...
    {
        public Dictionary<string, test_run_lib> testcase_lib;
        public tester_project tester_proj;
        public DataTable dt;
        public DataGridView reftb;
        public viewloader(ref DataGridView dataGrid, Dictionary<string, test_run_lib> testcase_lib, tester_project tester_proj)
        {
            this.testcase_lib = testcase_lib;    
            this.tester_proj = tester_proj;
            dt = dataGrid.DataSource as DataTable;
            reftb = dataGrid;
            set_dt_headr_name(new string[] { "ID", "测试描述", "上限", "下限", "测试值", "结论" ,"运行时间"});
        }
